 ...
 * 
 */
@WebServiceClient(name = "WeatherServiceImplService", targetNamespace = "http://service.itcast.cn/", wsdlLocation = "http://localhost:8092/ws/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICEIMPLSERVICE_QNAME = new QName("http://service.itcast.cn/", "WeatherServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8092/ws/weather?wsdl");
    ...
    public WeatherService getWeatherServiceImplPort() {
        return super.getPort(new QName("http://service.itcast.cn/", "WeatherServiceImplPort"), WeatherService.class);
    }
    ...
    public WeatherService getWeatherServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.itcast.cn/", "WeatherServiceImplPort"), WeatherService.class, features);
    }
